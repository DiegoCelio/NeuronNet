 ...
 */
    std::pair<size_t, double> degree(const size_t& index) const; 			// a completer
 ...
 */
    std::vector<std::pair<size_t, double> > neighbors(const size_t& index) const;  // a completer
 ...
 */
    std::set<size_t> step(const std::vector<double>& thalam);     //a completer
